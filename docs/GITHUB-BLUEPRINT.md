...
**Connected-Energy-AI holds most of the valuable code:** back it up in full first (`ops/github-consolidation/CEA-REVIEW.md` step 0), and move its active repos first.
Once a repo's contents are in the new org and verified, archive the old repo. When both old accounts are fully archived, remove their app installs.
