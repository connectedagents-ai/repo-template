...
| `litigationforce` | `LitigationForce.AI`, `litforce`, `litigationforce-aad-bridge`, CEA `lawsuite-monorepo`, `legal-case-assistant`, `Litigation-Force-Interactive-Presentation`. **Not** the case files: they go to the litigation evidence store (step 0), never into any repo |
